...
class Student extends Person{
    ...
    classclass(StudentList,wanted_class){
        console.log("Lop "+wanted_class+" :")
        for (let i = 0; i < StudentList.length; i++){
            if (StudentList[i].Class == wanted_class){
...
console.log("");
console.log("Loc hoc sinh theo lop:")
console.log(StudentList[0].classclass(StudentList,"12A"))
